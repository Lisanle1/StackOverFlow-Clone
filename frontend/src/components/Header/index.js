      ...
      <div className="header-container">
       ...
       {user?
          <div className="header-right-container">
            ...
            :<><NavLink to={'/auth'}><button style={{backgroundColor:"hsl(205deg 46% 92%)",color:"#39739D",width:"5em",height:"3em"}}>Login</button></NavLink>&nbsp;&nbsp;
            <NavLink to={'/auth'}><button style={{width:"5em",height:"3em"}}>Signup</button></NavLink></>}
        </div>
